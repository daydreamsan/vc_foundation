...
{
    if (self.popoverWidth > 0.f) {
        return self.popoverWidth;
    }
    CGFloat rowHeight = self.rowHeight > 0 ? self.rowHeight : kPopoverViewCellHeight;
    CGFloat maxWidth = 0.f, titleLeftEdge = 0.f, imageWidth = 0.f, imageMaxHeight = rowHeight - PopoverViewCellVerticalMargin*2;
...
{
    return self.rowHeight > 0 ? self.rowHeight : kPopoverViewCellHeight;
}
